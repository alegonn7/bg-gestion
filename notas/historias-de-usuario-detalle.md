# BG Gestión — Historias de Usuario (Detalle)

## AUTH — Autenticación
- HU-AUTH-1: Iniciar sesión con email y contraseña ✅
- HU-AUTH-2: Mantener sesión activa con JWT ✅
...
- HU-SUC-5: Ver detalle de sucursal con estadísticas ✅
- HU-SUC-6: Seleccionar sucursal activa ✅

## USR — Usuarios
- HU-USR-1: Ver listado de usuarios ✅
- HU-USR-2: Invitar nuevo empleado con credenciales temporales ✅
...
- HU-PROD-2: Crear producto en sucursal ✅
...
- HU-POS-2: Escanear código de barras por webcam ✅
...
- HU-UI-2: Dashboard con métricas reales del negocio ⬚
- HU-UI-3: Shortcuts de teclado en POS ⬚

---

**Total: 74** — 62 implementadas ✅ / 12 pendientes ⬚
